...
.. container:: Theorem
   ...
   **Theorem **\ **1.0.1** (within parenthesis)\ **.** *plain*
   *theoremstyle* here
...
.. container:: Lemma
   ...
   **Lemma **\ **1.0.3** (can cite 1.0.2)\ **.** *This* *one* *share*
   *counter* *with* *Theorem.*

   *Cite* *inside* *info* *only* *works* *with* ``ref{...}`` *syntax.*
   *As* *the* *conversion* *using* ``[@...]`` *to* *AST* *and* *walk*
   *and* *back* *to* *LaTeX* *would* *be* *too* *complex.*
...
.. container:: proof
   ...
   *proof * (Proof of the Main Theorem)\ *.* Predefined proof
   theoremstyle here

.. container:: KL

   **Klein’s Lemma **\ **1.0.1**\ **.** *Klein’s* *Lemma* *from*
   *amsthm* *doc.*
